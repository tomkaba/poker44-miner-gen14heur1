# poker44-miner-gen14heur1

Minimal release repository for model gen14heur1.

## Quick start

```bash
git clone https://github.com/tomkaba/poker44-miner-gen14heur1.git
cd poker44-miner-gen14heur1
python3 -m venv .venv
...
- Scorer is hardcoded to `gen14heur1`.
